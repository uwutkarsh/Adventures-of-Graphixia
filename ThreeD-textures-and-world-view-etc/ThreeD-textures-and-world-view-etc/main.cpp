...
int main() {
    ...
    unsigned char* data = stbi_load("C:/Users/Dell/Desktop/wallhaven-1kye91.jpg", &width, &height, &ncrChannels, 0);
    if (data == nullptr) {
        std::cout << "ERROR :: Cannot open the image required for TEXTURE" << std::endl;
    }
