...
int main() {
    ...
    Shader sourceShader("vSLightSource.txt", "fSLightSource.txt");
    float vertices[] = {    //vertices with the normals 
    ...
    //FIRST THE OBJECT CONFIGURATIONS
    GLuint VBO, objVAO;
    ...
    //SECOND SOURCE LIGHT CONFIGURATIONS
   ...
   glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)0);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // DRAWING THE SOURCE LIGHT OBJECT
        sourceShader.use();
        ...
        glfwSwapBuffers(window); // Don't forget to swap buffers!
        glfwPollEvents();
    }
